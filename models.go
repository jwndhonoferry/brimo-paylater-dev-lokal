...
type CeriaCreditCardDataByCifnoRequest struct {
	Cifno string `json:cifno`
}
type CeriaCreditCardDataByCifnoResponse struct {
	Cifno                           string  `json:"cifno" gorm:"column:CIFNO"`
	AccountNumber                   string  `json:"account_number" gorm:"column:ACCOUNT_NUMBER"`
	Name                            string  `json:"name" gorm:"column:NAME"`
	PayrollDate                     uint64  `json:"payroll_date" gorm:"column:PAYROLL_DATE"`
...
type CeriaCreditCardDataByAcctNoRequest struct {
	AcctNo string `json:accnum`
}
type CeriaCreditCardDataByAcctNoResponse struct {
	AccountNumber                   string  `json:"account_number" gorm:"column:ACCOUNT_NUMBER"`
	Cifno                           string  `json:"cifno" gorm:"column:CIFNO"`
	Name                            string  `json:"name" gorm:"column:NAME"`
	PayrollDate                     uint64  `json:"payroll_date" gorm:"column:PAYROLL_DATE"`
...
type CeriaKURDataByAcctNoRequest struct {
	AcctNo string `json:accnum`
}

type CeriaKURDataByIdNumberRequest struct {
	IdNumber string `json:idnumber`
}

type CeriaKURDataByAcctNoResponse struct {
	AccountNumber      string  `json:"account_number" gorm:"column:ACCOUNT_NUMBER"`
	Cifno              string  `json:"cifno" gorm:"column:CIFNO"`
	Name               string  `json:"name" gorm:"column:NAME"`
	KodePinjaman       string  `json:"kode_pinjaman" gorm:"column:KODE_PINJAMAN"`
	DeskripsiPinjaman  string  `json:"deskripsi_pinjaman" gorm:"column:DESKRIPSI_PINJAMAN"`
	Kolektibilitas     uint64  `json:"kolektibilitas" gorm:"column:KOLEKTIBILITAS"`
	KolektibilitasACRS uint64  `json:"kolektibilitas_acrs" gorm:"column:KOLEKTIBILITAS_ACRS"`
	TanggalRealisasi   string  `json:"tanggal_realisasi" gorm:"column:TANGGAL_REALISASI"`
	...
	KodeIdentitas      string  `json:"kode_identitas" gorm:"column:KODE_IDENTITAS"`
	NoIdentitas        string  `json:"no_identitas" gorm:"column:NO_IDENTITAS"`
}

type CeriaKURDataByIdNumberResponse struct {
	NoIdentitas        string  `json:"no_identitas" gorm:"column:NO_IDENTITAS"`
	AccountNumber      string  `json:"account_number" gorm:"column:ACCOUNT_NUMBER"`
	Cifno              string  `json:"cifno" gorm:"column:CIFNO"`
	Name               string  `json:"name" gorm:"column:NAME"`
