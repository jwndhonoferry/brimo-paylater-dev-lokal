...
func GenerateResponse(c *gin.Context, req CeriaDataResponse, resp_code string, resp_desc string) {
	c.JSON(http.StatusOK, gin.H{
		...
		"email":                              req.Email,
		"flag_pekerja_bri":                   req.FlagPekerjaBri,
		"bypass_validation":                  req.BypassValidation,
		"pg":                                 req.Pg,
		"flag_override":                      req.FlagOverride,
		"limit_override":                     req.LimitOverride,
	})
}
